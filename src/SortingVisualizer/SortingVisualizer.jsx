...
// Default color of the array bars.
...
export default class SortingVisualizer extends React.Component {
    ...
    testSortingAlgorithms() {
        // generate 50 random arrays for testing purposes
        for (let i = 0; i < 50; i++) {
            const array = [];
            ...
            // whichever sort we are testing
            const customSortedArray = getMergeSortAnimations(array.slice());
